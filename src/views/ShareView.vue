    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row" v-if="isAuthenticated">
                ...
                <p class="text-danger"><strong>Security notice: Never share/expose the urls</strong></p>
                <h3>Verification</h3>
                <ol>
                    <li>1. Click the button to generate and copy a verification URL</li>
                    ...
                    <li><em class="text-danger">Note: On auth token renewal, you must follow the verification steps again</em></li>
                </ol>
                ...
                <div :class="{ blur: !verification }">
                    ...
                    <ol>
                        ...
                        <li>2. Use the copied URL on a visible browser source inside your streaming APP:</li>
                ...
                <ol>
                    <li>1. Open the url {{serverURL}} on a visible browser source inside your Streaming APP</li>
                    ...
                    <li>5. Use the list URL on a visible browser source URL inside your streaming APP:</li>
